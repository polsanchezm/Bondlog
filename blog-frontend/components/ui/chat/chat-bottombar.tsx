...
import { loggedInUserData } from "@/components/ui/chat/hooks/data";
...
export default function ChatBottombar({ isMobile }: ChatBottombarProps) {
  ...
  const handleThumbsUp = () => {
    const newMessage: Message = {
      id: message.length + "sdsdssd2323",
      author_username: loggedInUserData.username,
      text: "👍",
      chat_id: "",
      author_id: "",
      created_at: formattedTime,
      updated_at: "",
      author_avatar: loggedInUserData.avatar,
      isLoading: false,
    };
    ...
    if (!hasInitialResponse) {
      ...
      setTimeout(() => {
        setMessages((messages) => [
          ...
          {
            id: messages.length + "ssdgfsdfdstgfds223dsdsds22",
            author_avatar:
